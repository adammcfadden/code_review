...
describe('The word counter path', {:type => :feature}) do
  it('receive sentence and word search input from the user, send those through the word_counter method and return the values on the counter page') do
    ...
    file_in('sentence', :with => 'The Blue moon was rising up over bluetown and the blue boy picked some berries. His blue dog chased a blue squirrel to the "Blue Tavern" and came back with a pint.')
    click_button('sumbit_search')
